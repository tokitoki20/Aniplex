...
function urlAnime() {
		...
		mySeasons[0].href = `seasonalAnimeOther.html#${mySeasons[0].classList[1]}-${mySeasons[0].classList[2]}`

		mySeasons[1].href = `seasonalAnimeOther.html#${mySeasons[1].classList[1]}-${mySeasons[1].classList[2]}`

		mySeasons[2].href = `seasonalAnimeOther.html#${mySeasons[2].classList[1]}-${mySeasons[2].classList[2]}`

		mySeasons[3].href = `seasonalAnimeOther.html#${mySeasons[3].classList[1]}-${mySeasons[3].classList[2]}`
...
if (locationHref === "http://localhost:3000/Anime/seasonalAnimeOther.html#Airing") {
...
}else if (locationHref === "http://localhost:3000/Anime/seasonalAnime.html") {
    fetchSeasonData("https://api.jikan.moe/v4/seasons/now", "TV");
    ...
    let seasonUrl = `https://api.jikan.moe/v4/seasons/${myYearSeason[1]}/${myYearSeason[0]}`;
